...
var CommentWhere = struct {
	...
	AuthorId:  whereHelperstring{field: "`comment`.`authorId`"},
	PhotoId:   whereHelperstring{field: "`comment`.`photoId`"},
...
var (
	commentAllColumns            = []string{"id", "created_at", "authorId", "photoId", "comment"}
	commentColumnsWithoutDefault = []string{"id", "authorId", "photoId", "comment"}
...
func (q commentQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Comment, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "internal: failed to execute a one query for comment")
	}
...
func (q commentQuery) All(ctx context.Context, exec boil.ContextExecutor) (CommentSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "internal: failed to assign all query results to Comment slice")
	}
...
func (q commentQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "internal: failed to count comment rows")
	}
...
func (q commentQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "internal: failed to check if comment exists")
	}
...
func FindComment(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Comment, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "internal: unable to select from comment")
	}
...
func (o *Comment) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("internal: no comment provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "internal: unable to insert into comment")
	}
	...
	if err != nil {
		return errors.Wrap(err, "internal: unable to populate default values for comment")
	}
...
func (o *Comment) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("internal: unable to update comment, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "internal: unable to update comment row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "internal: failed to get rows affected by update for comment")
	}
...
func (q commentQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "internal: unable to update all for comment")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "internal: unable to retrieve rows affected for comment")
	}
...
func (o CommentSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "internal: unable to update all in comment slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "internal: unable to retrieve rows affected all in update all comment")
	}
	return rowsAff, nil
}
...
func (o *Comment) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("internal: no comment provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("internal: unable to upsert comment, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "internal: unable to upsert for comment")
	}
	...
	if err != nil {
		return errors.Wrap(err, "internal: unable to retrieve unique values for comment")
	}
...
func (o *Comment) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("internal: no Comment provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "internal: unable to delete from comment")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "internal: failed to get rows affected by delete for comment")
	}
...
func (q commentQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("internal: no commentQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "internal: unable to delete all from comment")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "internal: failed to get rows affected by deleteall for comment")
	}
...
func (o CommentSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "internal: unable to delete all from comment slice")
	}
...
func (o *CommentSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "internal: unable to reload all in CommentSlice")
	}
...
func CommentExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "internal: unable to check if comment exists")
	}
